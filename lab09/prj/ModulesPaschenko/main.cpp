...
string waves(int userChoice)
{
    ...
    struct WAVES{
        ...
        string infoOutput()
        {
            string info = "\nÂèñîòà õâèë³: " + waveHeight + ", îïèñ õâèë³: " + description;
            return info;
        }
    };
...
int numbers(int loopSize)
{
    ...
    cout << endl << "Ğåçóëüòàò: " << "ê³ëüê³ñòü â³ä'ºìíèõ ÷èñåë: " << result[0] << ", ê³ëüê³ñòü ÷èñåë, ÿê³ ğ³âí³ íóëş: " << result[1] << ", ê³ëüê³ñòü ÷èñåë, ùî ëåæèòü ó ä³àïàçîí â³ä 5 äî 1024: " << result[2] << endl;
}
